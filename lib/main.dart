...
void main() async {
  ...
  // Pre-initialize ML Kit by triggering platform channel
  // This ensures ML Kit is ready before first use
  try {
    debugPrint('[ML Kit] Pre-initializing...');
    await Future.delayed(const Duration(milliseconds: 200));
    debugPrint('[ML Kit] Pre-initialization complete');
  } catch (e) {
    debugPrint('[ML Kit] Pre-initialization note: $e');
  }
  runApp(const MyApp());
}
